        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                ...
                if (needConfirm === false) {
                    items = amisCore.spliceTree(items, next, 0, amisCore.getTree(items, indexes));
                }
                else {
                    // 复制相当于新增一行
                    // 需要同addItem一致添加__placeholder属性
                    items = amisCore.spliceTree(items, next, 0, tslib.__assign(tslib.__assign({}, amisCore.getTree(items, indexes)), { __isPlaceholder: true }));
                }
                    ...
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.dispatchEvent('add', {
                                    ...
                                    indexPath: next.join('.'),
                                    item: amisCore.getTree(items, next)
                                })];
                            case 1:
                                isPrevented = _a.sent();
                                if (isPrevented) {
                    ...
                    case 1:
                        ...
                        amisCore.everyTree(items_5, function (item, index, paths, indexes) {
                            promises_1.unshift(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, amisCore.evalExpressionWithConditionBuilder(condition, item)];
                                        case 1:
                                            isUpdate = _a.sent();
                                            if (isUpdate) {
                    ...
                    case 7:
                        ...
                        amisCore.everyTree(items_7, function (item, index, paths, indexes) {
                            promises_2.unshift(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, amisCore.evalExpressionWithConditionBuilder(args === null || args === void 0 ? void 0 : args.condition, item)];
                                        case 1:
                                            result = _a.sent();
                                            if (result) {
