...
import { __extends, __assign, __awaiter, __generator, __decorate, __spreadArray, __read, __rest } from 'tslib';
import React from 'react';
import { findDOMNode } from 'react-dom';
import Sortable from 'sortablejs';
import omit from 'lodash/omit';
import { getPropValue, resolveVariableAndFilter, anyChanged, isPureVariable, createObject, difference, filter, evalExpressionWithConditionBuilder, Renderer, ListStore, isClickOnInput, isVisible, isDisabled, filterClassNameObject } from 'amis-core';
...
/** @class */ ((function (_super) {
    ...
    ListRenderer.prototype.setData = function (values, replace, index, condition) {
        return __awaiter(this, void 0, void 0, function () {
            var store, items_1, indexs, items, len, i, item, isUpdate;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        indexs.forEach(function (i) {
                            ...
                            (_a = items_1[intIndex]) === null || _a === void 0 ? void 0 : _a.updateData(values);
                        });
                        return [3 /*break*/, 7];
                    case 1:
                    ...
                    case 2:
                        ...
                        item = items[i];
                        return [4 /*yield*/, evalExpressionWithConditionBuilder(condition, item.data)];
                    case 3:
                        isUpdate = _a.sent();
                        if (isUpdate) {
                    ...
                    case 6: return [2 /*return*/, store.updateData(values, undefined, replace)];
